...
public enum BizCodeEnum {
     ...
     * 流ᰁ包操作
     */
    TRAFFIC_FREE_NOT_EXIST(600101, "免费流ᰁ包不存在，联 系客服"),
    TRAFFIC_REDUCE_FAIL(600102, "流ᰁ不⾜，扣减失败"),
    TRAFFIC_EXCEPTION(600103, "流ᰁ包数据异常,⽤户⽆流ᰁ 包"),
    /**
     * 通⽤操作码
     */
     ...
     * ⽂件相关
     */
    FILE_UPLOAD_USER_IMG_FAIL(700101, "⽤户头像⽂件上传 失败");
